...
export async function preparePublic({ rootDir }) {
    ...
    for (const filename of ['admin.html', 'admin-login.html', 'banner-inquiry.html', 'service-guide.html', 'operator.html', 'terms.html', 'privacy.html', 'changelog.html', 'manifest.webmanifest', 'service-worker.js', '_headers', 'robots.txt']) {
        await copyIfPresent(
